...
public class PListAdpater extends RecyclerView.Adapter<PListAdpater.ViewHolder> {

    Context context;
    ArrayList<TypeModel> model;


    public PListAdpater(Context context, ArrayList<TypeModel> model) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.plist_layout,parent,false);
