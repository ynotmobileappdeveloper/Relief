...
public class PharmCategory extends RecyclerView.Adapter<PharmCategory.ViewHolder> {

    Context context;
    ArrayList<PharmCategoryModel> model;
    Click listener;

    public PharmCategory(Context context, ArrayList<PharmCategoryModel> model, Click listener) {
