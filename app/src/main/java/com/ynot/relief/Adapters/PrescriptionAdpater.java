...
public class PrescriptionAdpater extends RecyclerView.Adapter<PrescriptionAdpater.ViewHolder> {
    ...
    public PrescriptionAdpater(Context context, ArrayList<TypeModel> model, Click listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.presc_layout,parent,false);
