...
public class TypeAMedicine extends AppCompatActivity {
    RecyclerView rec;
    Button add, order;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_type_a_medicine);
        ...
        progress = new ACProgressFlower.Builder(TypeAMedicine.this)
        ...
        dialog = new Dialog(TypeAMedicine.this);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (medi_id.isEmpty()) {
                    ...
                    name.requestFocus();
                    Toast.makeText(TypeAMedicine.this, "You can only Choose medicine from List !!", Toast.LENGTH_LONG).show();
                    return;
                }
                String selected = name.getText().toString();

                for (int i = 0; i < medi_model.size(); i++) {
                    if (selected.equals(medi_model.get(i).getName())) {
                        if (medi_model.get(i).getNeed_pres().equals("1")) {
                        ...
                        try {
                            ...
                            if (ob.getBoolean("status")) {
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    ...
                                    String pres;
                                    if (obb.has("medicine_status")) {
                                        pres = obb.getString("medicine_status");
                                    } else {
                                        pres = "0";
                                    }
                                    Log.e("pres", obb.getString("medicine_id") + " " + obb.getString("medicine_name"));
                                    //  Log.e("position", String.valueOf(i));
                                    //  Log.e("id", obb.getString("medicine_id"));
                                    medi_model.add(new MediProduct(obb.getString("medicine_id"), obb.getString("medicine_name"), obb.getString("medicine_status")));
                                }
                                adapter = new ArrayAdapter<String>(TypeAMedicine.this, android.R.layout.simple_spinner_dropdown_item, medicines);
