...
public class EnquiryPage extends AppCompatActivity implements View.OnClickListener {
    String gender = "male";
    ...
    private void enquiry() {
        dialog.show();
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URLs.ENQUIRY,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            {
                                Toast.makeText(EnquiryPage.this, ob.getString("message"), Toast.LENGTH_SHORT).show();
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("requirement", enq.getText().toString());
