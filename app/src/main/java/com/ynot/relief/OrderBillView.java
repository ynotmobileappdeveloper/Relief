...
public class OrderBillView extends AppCompatActivity {
    RecyclerView rec;
    BillAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_bill_view);

        edit_view = new Dialog(OrderBillView.this);
    ...
    private void get_bill_data() {
        dialo.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.ORDER_BILL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (ob.getBoolean("status")) {
                                ...
                                Toast.makeText(OrderBillView.this, ob.getString("message"), Toast.LENGTH_SHORT).show();
                            }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            JSONObject ob = new JSONObject(response);
                            if (ob.getBoolean("status")) {
                                Toast.makeText(OrderBillView.this, "Successfully Confirmed !!", Toast.LENGTH_SHORT).show();
                                approve.setVisibility(View.GONE);
                            } else {
                                Toast.makeText(OrderBillView.this, "Something Went Wrong !!", Toast.LENGTH_SHORT).show();
                            }
